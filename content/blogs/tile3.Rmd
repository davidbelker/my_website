...
draft: false
image: fed.jpg # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work

keywords: ""
slug: tile3 # slug is the shorthand URL address... no spaces plz
...
```{r download_historical_yield_curve, warning=FALSE, echo=FALSE}
...
### Yields on US rates by maturity since 1960


```{r yield_curve_1_group_1, out.width="100%", fig.width = 12, fig.height= 10, echo=FALSE}
yield_curve  %>% 
...
```{r yield_curve_2_group_1, out.width="100%", fig.width = 12, fig.height = 10, echo=FALSE}
...
```{r yield_curve_31, fig.width=12, echo=FALSE}
...
```{r final_part_challenge_1, fig.width = 15, fig.height = 10, echo=FALSE}
recessions <- tibble(
...
```{r setup_US-recessions, warning=FALSE, echo=FALSE}
