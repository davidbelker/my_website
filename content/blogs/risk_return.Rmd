...
Below you can see the distribution of monthly returns for the 30 Dow Jones Industrial Average stocks as well as the risk-return trade-off. The respective periods are given in the subtitles of the graphs.

```{r, tickers_from_wikipedia, echo=FALSE}
